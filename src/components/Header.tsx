...
export default function Header() {
  ...
  // The header's real height varies (the top status bar wraps to different
  // numbers of lines depending on viewport width), so the page content's
  // top offset is measured live rather than guessed with a fixed padding —
  // a fixed guess drifts out of sync and lets the fixed header cover content.
  useLayoutEffect(() => {
